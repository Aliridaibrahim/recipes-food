...
class AfricanWidget extends StatefulWidget {

  @override
  State<AfricanWidget> createState() => _AfricanWidgetState();
}

class _AfricanWidgetState extends State<AfricanWidget> {
  @override
  Widget build(BuildContext context) {
    final datt = Provider.of<BooksList>(context);
    return Container(
